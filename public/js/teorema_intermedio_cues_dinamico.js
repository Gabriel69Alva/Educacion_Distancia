...
document.addEventListener('DOMContentLoaded', function () {
    try {
        ...
        var l3_horizontal = brd.create('segment', [p5_line, p6_line], { color: '#aaafacff', size: 15, strokeWidth: 5, fixed: true, layer: 0, visible: true });


        var l3_horizontal = brd.create('segment', [p7_line, p8_line], { color: '#aaafacff', size: 15, strokeWidth: 5, fixed: true, layer: 0, visible: true });
